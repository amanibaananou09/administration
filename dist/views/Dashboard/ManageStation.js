// Chakra imports
import { Button, Flex, Skeleton, Stack, Text, useColorModeValue, } from "@chakra-ui/react";
...
const ManageStation = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Flex, { direction: "column", pt: { base: "120px", md: "75px" } },
            React.createElement(Card, { my: { lg: "24px" }, me: { lg: "24px" } },
                React.createElement(Flex, { direction: "column" },
                    React.createElement(CardHeader, { py: "12px" },
                        React.createElement(Flex, { align: "center", justify: "space-between", p: "22px" },
                            React.createElement(Text, { fontSize: "lg", color: textColor, fontWeight: "bold" }, "Manage Stations"),
                            React.createElement(Button, { variant: "primary", maxH: "30px", onClick: () => openStationModal() }, "CREATE STATION"))),
                    React.createElement(CardBody, null,
                        React.createElement(Flex, { direction: "column", w: "100%" },
                            stations.map((row, key) => {
                                return (React.createElement(StationRow, { id: row.id, name: row.name, address: row.address, controllerId: row.controllerId, controllerPtsId: row.controllerPtsId, firmwareVersion: row.version, onEdit: () => openStationModal(row), onDelete: () => openConfirmationToDeleteModal(row), key: key }));
                            }),
                            stations.length == 0 && (React.createElement(Stack, { width: "100%", margin: "20px 0px" },
                                React.createElement(Skeleton, { height: "200px", borderRadius: "10px" }),
                                React.createElement(Skeleton, { height: "200px", borderRadius: "10px" })))))))),
        React.createElement(StationModal, { onSubmit: submitModalHandler, ref: stationModalRef }),
        React.createElement(ConfirmationModal, { message: "Are you sure you want to delete this station ?", onConfirm: deleteStationHandler, ref: confirmationModalRef })));
};
