...
export default function AdminNavbar(props) {
    ...
    return (React.createElement(Flex, { position: navbarPosition, boxShadow: navbarShadow, bg: navbarBg, borderColor: navbarBorder, filter: navbarFilter, backdropFilter: navbarBackdrop, borderWidth: "1.5px", borderStyle: "solid", transitionDelay: "0s, 0s, 0s, 0s", transitionDuration: " 0.25s, 0.25s, 0.25s, 0s", "transition-property": "box-shadow, background-color, filter, border", transitionTimingFunction: "linear, linear, linear, linear", alignItems: { xl: "center" }, borderRadius: "16px", display: "flex", minH: "75px", justifyContent: { xl: "center" }, lineHeight: "25.6px", mx: "auto", mt: secondaryMargin, pb: "8px", left: "", right: "30px", px: {
            sm: paddingX,
            md: "30px",
        }, ps: {
            xl: "12px",
        }, pt: "8px", top: "18px", w: { sm: "calc(100vw - 30px)", xl: "calc(100vw - 75px - 275px)" } },
        React.createElement(Flex, { w: "100%", flexDirection: {
                sm: "column",
                md: "row",
            }, alignItems: { xl: "center" } },
            React.createElement(Box, { mb: { sm: "8px", md: "0px" } },
                React.createElement(Breadcrumb, null,
                    React.createElement(BreadcrumbItem, { color: mainText },
                        React.createElement(BreadcrumbLink, { href: "#", color: secondaryText }, "Pages")),
                    React.createElement(BreadcrumbItem, { color: mainText },
                        React.createElement(BreadcrumbLink, { href: "#", color: mainText }, brandText))),
                React.createElement(Link, { color: mainText, href: "#", bg: "inherit", borderRadius: "inherit", fontWeight: "bold", _hover: { color: { mainText } }, _active: {
                        bg: "inherit",
                        transform: "none",
            ...
            React.createElement(Box, { ms: "auto", w: { sm: "100%", md: "unset" } },
                React.createElement(AdminNavbarLinks, { onOpen: props.onOpen, logoText: props.logoText, secondary: props.secondary, fixed: props.fixed, scrolled: scrolled })))));
}
