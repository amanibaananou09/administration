...
const TankLevelChart = () => {
    ...
    const [chartOptions, setChartOptions] = useState(tankLevelChartConfig.options);
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ReactApexChart, { options: chartOptions, series: chartSeries, type: "line", width: "100%", height: "500px" })));
};
