...
export const renderTrack = ({ style, ...props }) => {
    ...
    return React.createElement("div", Object.assign({ style: { ...style, ...trackStyle } }, props));
};
export const renderThumbDark = ({ style, ...props }) => {
    ...
    return React.createElement("div", Object.assign({ style: { ...style, ...thumbStyle } }, props));
};
...
export const renderView = ({ style, ...props }) => {
    ...
    return React.createElement("div", Object.assign({ style: { ...style, ...viewStyle } }, props));
};
